...
export const metadata: Metadata = {
  ...
  description: 'Join MEI Innovations — a remote-first technology team building real software for real international businesses. Apply now and send your CV to info@buildwithmei.com.',
