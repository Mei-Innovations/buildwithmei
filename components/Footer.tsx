...
import { ArrowRight, Mail, MessageCircle, Instagram, Facebook, Linkedin } from 'lucide-react';
...
const LI = "https://linkedin.com/company/mei-innovations";
    ...
    <section id="contact" className="py-32 relative overflow-hidden bg-[#0B1020] border-t border-white/5">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <div className="text-[10px] font-mono tracking-widest text-[#555] uppercase mb-6">Start the conversation</div>
          ...
          <p className="text-lg text-[#666] font-light mb-10 max-w-2xl mx-auto leading-relaxed">
            Whether you're launching your first website or automating your entire operation — we'll show you exactly what's possible in a free 30-minute call. No commitment. No sales pitch.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Link href="/contact" className="h-13 px-8 py-4 rounded-md bg-brand-emerald text-white font-semibold flex items-center justify-center gap-2 hover:bg-[#3d7260] transition-all shadow-[0_0_40px_rgba(77,139,114,0.3)] text-base">
                <Mail size={16} /> Book Free Strategy Call <ArrowRight size={16} />
              </Link>
            </motion.div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 text-xs text-[#444] font-mono">
            <span>✓ No commitment required</span>
            <span>✓ New business or established</span>
            <span>✓ Worldwide clients</span>
          </div>
          <div className="mt-8 flex items-center justify-center">
            <a href="mailto:info@buildwithmei.com" className="flex items-center gap-2 hover:text-brand-emerald transition-colors font-mono text-sm text-[#555]">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-sm text-[#999] font-light leading-relaxed mb-1">Modern Ecosystem Intelligence.</p>
            <p className="text-xs text-[#777] font-mono mb-1">Established 2014 · Worldwide.</p>
            <p className="text-xs text-[#777] font-light mb-6">Intelligent Systems. Built for Scale.</p>

            {/* Email only — number hidden */}
            <a href="mailto:info@buildwithmei.com" className="flex items-center gap-2 text-sm text-[#888] hover:text-brand-emerald transition-colors font-mono mb-4">
              <Mail size={13} /> info@buildwithmei.com
            </a>
            ...
            <div className="flex items-center gap-3">
              <a href={WA} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-[#12182B] border border-white/5 flex items-center justify-center text-[#888] hover:text-[#25D366] hover:border-[#25D366]/30 transition-all duration-300"
                aria-label="WhatsApp">
                <MessageCircle size={15} />
              </a>
              <a href={IG} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-[#12182B] border border-white/5 flex items-center justify-center text-[#888] hover:text-[#E1306C] hover:border-[#E1306C]/30 transition-all duration-300"
                aria-label="Instagram">
                <Instagram size={15} />
              </a>
              <a href={FB} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-[#12182B] border border-white/5 flex items-center justify-center text-[#888] hover:text-[#1877F2] hover:border-[#1877F2]/30 transition-all duration-300"
                aria-label="Facebook">
                <Facebook size={15} />
              </a>
              <a href={LI} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-[#12182B] border border-white/5 flex items-center justify-center text-[#888] hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-all duration-300"
                aria-label="LinkedIn">
                <Linkedin size={15} />
              </a>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-20">
            <div>
              ...
              <ul className="space-y-3 text-sm text-[#888] font-light">
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-sm text-[#777] font-light leading-relaxed mb-4">Free 30-minute strategy call. No commitment. We start where you are.</p>
              <Link href="/contact" className="inline-flex items-center gap-1.5 text-sm text-brand-emerald hover:text-white transition-colors font-medium">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <a href={IG} target="_blank" rel="noopener noreferrer" className="text-xs text-[#555] hover:text-[#E1306C] transition-colors font-mono">Instagram</a>
            <span className="text-[#333]">·</span>
            <a href={FB} target="_blank" rel="noopener noreferrer" className="text-xs text-[#555] hover:text-[#1877F2] transition-colors font-mono">Facebook</a>
            <span className="text-[#333]">·</span>
            <a href={LI} target="_blank" rel="noopener noreferrer" className="text-xs text-[#555] hover:text-[#0A66C2] transition-colors font-mono">LinkedIn</a>
          </div>
          <div className="text-xs text-[#444] font-mono tracking-widest uppercase">Innovate · Integrate · Elevate</div>
        </div>
      </div>
    </footer>
  );
