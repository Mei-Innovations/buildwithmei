...
export const markets = [
  {
    ...
    imgAlt: 'US business team in a strategy meeting', flag: '🇺🇸', name: 'United States',
  ...
  },
  {
    ...
    imgAlt: 'City of London financial district at dusk', flag: '🇬🇧', name: 'United Kingdom',
  ...
  },
  {
    ...
    imgAlt: 'Elegant European hotel reception', flag: '🇪🇺', name: 'Europe',
  ...
  },
  {
    ...
    imgAlt: 'Dubai skyline with iconic architecture', flag: '🇦🇪', name: 'United Arab Emirates',
  ...
  },
  {
    ...
    imgAlt: 'Professional services team in a modern office', flag: '🇨🇦', name: 'Canada',
  ...
  },
  {
    ...
    imgAlt: 'Solar and wind energy infrastructure at sunset', flag: '🇸🇦', name: 'Saudi Arabia',
...
const marketTypes = [
  { name: 'Mature Markets', regions: 'US · Canada · Europe',
    desc: 'Helping established businesses modernize operations, automate workflows and integrate AI.' },
  { name: 'Growth Markets', regions: 'Middle East · Asia',
    desc: 'Building scalable digital foundations for rapidly expanding businesses.' },
  { name: 'Premium Experience Markets', regions: 'Europe · incl. Switzerland',
    desc: 'Creating intelligent ecosystems for hospitality, healthcare, luxury and service industries.' },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {marketTypes.map((t, i) => (
              <div key={t.name} className="p-6 rounded-xl bg-[#12182B] border border-white/5">
                <div className="text-[10px] font-mono text-brand-emerald tracking-widest uppercase mb-2">{t.regions}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {markets.map((m, i) => (
            <motion.div key={m.id} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
              ...
              className="group rounded-xl bg-[#12182B] border border-white/5 hover:border-brand-emerald/20 transition-all duration-400 flex flex-col overflow-hidden">
              <div className="relative h-36 overflow-hidden">
                ...
                <span className="absolute bottom-3 left-6 text-3xl drop-shadow" aria-hidden>{m.flag}</span>
              </div>
